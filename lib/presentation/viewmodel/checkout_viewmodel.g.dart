...
mixin _$CheckoutViewModel on CheckoutViewModelBase, Store {
  late final _$productIdControllerAtom =
      Atom(name: 'CheckoutViewModelBase.productIdController', context: context);

  @override
  TextEditingController get productIdController {
    _$productIdControllerAtom.reportRead();
    return super.productIdController;
  }

  @override
  set productIdController(TextEditingController value) {
    _$productIdControllerAtom.reportWrite(value, super.productIdController, () {
      super.productIdController = value;
    });
  }
